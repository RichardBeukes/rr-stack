...
namespace NzbDrone.Core.DecisionEngine.Specifications
{
    public class AcceptableSizeSpecification : IDownloadDecisionEngineSpecification
    {
        ...
        public DownloadSpecDecision IsSatisfiedBy(RemoteMovie subject, SearchCriteriaBase searchCriteria)
        {
            ...
            {
                _logger.Debug("Release has unknown size, rejecting as potential fake");
                return DownloadSpecDecision.Reject(DownloadRejectionReason.BelowMinimumSize, "Release has no size information - potential fake or incomplete release");
            }
